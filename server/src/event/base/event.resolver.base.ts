...
export class EventResolverBase {
    ...
    return await this.service.createEvent({
      ...
      data: {
        ...
        participants: args.data.participants
          ? {
              connect: args.data.participants,
            }
          : undefined,
      },
    });
  ...
  async getParticipants(@graphql.Parent() parent: Event): Promise<User | null> {
    const result = await this.service.getParticipants(parent.id);
